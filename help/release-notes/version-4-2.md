---
helpx_url: "https://helpx.adobe.com/kr/substance-3d-sampler/release-notes/version-4-2.html"
breadcrumb-title: ''
...
이미지 투 재질 은 단일 이미지에서 재료 채널(기본 색상, 거칠기, 표준, 변위 및 금속)을 생성합니다.
...
이를 통해 저해상도 텍스처의 화질과 디테일 수준을 높이고 텍스처 확대 시 맵 간의 기능 일관성을 유지할 수 있습니다.
...
* [레이어] 레이어 스택 레이어의 해상도를 표시합니다.
* [레이어] 이제 레이어 계산 해상도를 문서 크기 또는 입력 크기로 설정할 수 있습니다.
* [레이어] 레이어 스택에서 레이어 해상도 표시
...
* [레이어] 이제 AI(Image to Material) 레이어 계산을 더 빠르게 취소할 수 있어 레이어 스택 조정 시 렌더링 시간이 향상됩니다
* [레이어] 이제 업스케일 레이어 계산을 더 빨리 취소할 수 있어 레이어 스택을 조정할 때 렌더링 시간을 단축할 수 있습니다
* [내보내기] 내보낸 텍스처의 재정의 해상도 허용
* [내보내기] 이제 내보낼 채널 목록이 정렬됩니다.
* [내보내기] 내보낼 채널 목록에 채널 해상도 표시
* [응용 프로그램] GPU 가속 신경망을 활성화하거나 비활성화하는 새 환경 설정
* [UI] 해상도 드롭다운이 개선됨
* [UI 아이콘 for Weave mesh] 새로운 메쉬 프로세스 및 직조 필터
...
* [응용 프로그램] [프로젝트] 패널에서 에셋을 복제할 때 충돌 발생
