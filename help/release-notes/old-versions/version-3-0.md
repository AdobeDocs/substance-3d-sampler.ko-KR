...
이제 Sampler을 사용하여 재질 그 이상을 제작할 수 있습니다. 환경 조명은 [자체 필터 집합](../../filters/hdri-tools/hdri-tools.md)을 사용하는 새로운 유형의 에셋입니다. [괄호로 묶은 360 사진](../../filters/hdri-tools/hdr-merge.md)에서 시작하거나, [처음부터](../../filters/hdri-tools/shape-light.md) 환경 조명을 만들거나, [기존 HDR 파일을 편집](../../filters/hdri-tools/nadir-patch.md)하세요.
...
* [뒤틀기](../../filters/tools/warp-transform.md)
...
* &lbrack;UI 특정 필터에 직접 액세스 할 수있는 새로운 도구 모음 (자르기, 변환, 원근감, 복제 스탬프)
...
* [UI] 단축키 - &quot;2&quot;를 사용하여 2D 보기 가시성을 전환합니다.
* [UI] 단축키 - &quot;3&quot;을 사용하여 3D 보기의 가시성을 전환합니다.
...
* [환경 조명] 템플릿을 생성할 때 이미지를 드래그하여 놓으면 환경 조명 생성 환경 조명 창이 표시됩니다.
* [환경 조명] 환경 조명 생성 템플릿에서 환경 가져오기 를 선택하여 3D 보기의 환경에 이미지를 할당합니다
* [환경 조명] 환경 조명 생성 템플릿에서 HDR 병합 을 선택하여 노출이 다른 여러 개의 360도 이미지에서 환경 조명을 생성합니다
* [환경 조명] 환경 조명 생성 템플릿에서 환경 조명을 생성하기 전에 &quot;비트맵으로 사용&quot;을 선택하여 이미지를 편집합니다
* [환경 조명] 이미지 가져오기 레이어에서 환경 사용을 할당하여 3D 보기의 환경에 이미지를 직접 할당합니다
* [환경 조명] 환경 채널의 2D 보기에서 렌더링을 3D 보기에서와 동일하게 표시하도록 자동 색상 교정이 있습니다
...
* [내보내기] Adobe Substance 3D Painter으로 재질 및 환경 조명 보내기
* [내보내기] Adobe Substance 3D Stager으로 환경 조명 보내기
* [렌더링] 이제 새 질감 속성을 지원하고 3D로 렌더링합니다
* [렌더링] 광택 지원(광택 색상, 광택 불투명도 및 광택 거칠음) 추가
* [렌더링] 코팅 지지체(코팅 색상, 코팅 거칠기, 코팅 정상, 코팅 반사 수준 및 코팅 IOR) 추가
* [렌더링] 비등방성 지원(비등방성 레벨 및 비등방성 각도) 추가
...
* [렌더링] 실시간 엔진(2021) 렌더러는 반투명도, 흡수 및 재질 속성을 지원합니다
...
* [셰이더 설정 패널] 새 매개 변수(표준 비율, Height 비율, Height 수준, 방출 강도, IOR, 코팅 정상 강도 및 코트 IOR)
* [셰이더 설정 패널] 실시간 엔진 2021에 대한 특정 매개 변수(서브서피스 스캐터링, 스캐터링 거리, 빨강 시프트 및 레일리 스캐터링)
* [셰이더 설정 패널] 설정 값은 에셋별로 저장됩니다
* [환경 조명 설정 패널] 기본 뷰어 미리 보기를 추가했습니다.
...
* [내용] 타일링 - 완벽한 타일링을 위해 잘린 이음새를 페인트로 만드는 옵션
...
* [Realtime Engine 2021] 레이아웃 변경, 응용 프로그램 충돌
* [Realtime Engine 2021] 대용량 계산, 응용 프로그램 충돌
* [패널] MacOS - 고정 해제된 패널이 모든 애플리케이션 앞에 있음
* [위젯]이 사라지고 위치 위젯이 사라질 수 있습니다. 레이어를 숨기거나 숨김 해제하여 표시합니다.
