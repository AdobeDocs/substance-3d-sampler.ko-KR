...
이 페이지에는 Sampler 베타 버전에 대한 변경 로그가 포함되어 있습니다. [FAQ](../faq.md)에서 베타에 액세스하는 방법을 알아보십시오.

>[!NOTE]
>
>Sampler 베타 버전을 항상 사용할 수 있는 것은 아닙니다. 향후 베타가 출시되는 시기를 확인하려면 Substance 3D 소셜 채널을 팔로우하십시오.
...
* [Firefly] 생성된 이미지에 출처가 있는 매니페스트가 포함되어 있습니다.
