...
breadcrumb-title: ''
description: Substance 3D Sampler 버전 4.3의 릴리스 노트를 통해 새로운 텍스처 생성기, 자수 필터 및 원근감 자르기 도구에 대해 알아보십시오.
...
<b>Substance 3D Sampler 4.3</b>에서는 <b>텍스처 생성기</b>, 새로운 버전의 <b>자수</b> 필터 및 <b>원근 자르기</b> 도구를 포함한 새로운 스타터 콘텐츠를 소개합니다.
...
새로운 원근감 자르기 도구를 사용하면 4개의 조절점으로 왜곡된 재질과 스캔을 잘라 원근감 아티팩트를 제거하고 타일링 가능한 에셋을 얻을 수 있습니다.
...
채우기 필터의 업그레이드 버전에서는 혼합 모드가 도입되어 값, 입력 맵 또는 채우기의 텍스처 생성기를 아래 레이어의 채널 결과와 곱할 수 있습니다.

## 이미지 가져오기 레이어 개선 사항

![](../assets/Import-Layer-improvements.gif)

이미지 가져오기 레이어에 여러 이미지를 추가하고 이미지의 알파 채널에서 불투명도 맵을 생성할 수 있습니다.
...
* [Application] 그래픽 API를 초기화할 때 충돌이 시작됩니다
* [응용 프로그램] 프로젝트 이름에 # 문자가 포함된 경우 충돌
* [응용 프로그램] 이전 프로젝트를 열 때 가능한 충돌
