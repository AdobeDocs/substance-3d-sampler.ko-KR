---
helpx_url: "https://helpx.adobe.com/kr/substance-3d-sampler/filters/generators/quilt-stitch.html"
breadcrumb-title: ''
description: Substance 3D Sampler의 퀼트 스티치 생성기를 사용하여 퀼트 직물 패턴과 재료용 스티칭 텍스처를 생성합니다.
...
* **0 강도**\
  직물의 이음매에 미치는 영향의 정도를 조정합니다. 이 효과는 매우 미묘합니다.
...
* **기본 재질 Height**: 0-1\
  기본 재질의 높이 맵 강도 조정
* **표준 강도**: 0-1\
  **퀼트 스티치** 필터로 인한 노멀 맵 변경 강도를 조정합니다. 이는 기본 재질의 표준에는 영향을 주지 않습니다.
