---
helpx_url: 'https://helpx.adobe.com/kr/substance-3d-sampler/filters/compound-filters.html'
breadcrumb-title: ''
...
버전 번호를 사용하면 다른 반복을 계속 추적할 수 있습니다. 이전 버전의 복합 필터로 완료한 레이어 스택을 열면 최신 버전으로 업그레이드하라는 알림이 표시됩니다.

### 노드

노드는 Substance 3D Sampler 내부 필터를 참조할 수 있습니다. 내부 필터 **InternalFilter**&#x200B;의 레이블과 노드 사이의 링크를 정의하는 데 사용할 고유한 식별자 **Id**&#x200B;을(를) 정의합니다.
...
노드는 Substance 3D Sampler에 없는 SBSAR 파일을 참조할 수 있습니다. 노드 간의 식별자와 SBSAR 파일의 파일 이름 **파일**&#x200B;을 정의하는 데 사용할 고유한 노드 **Id**&#x200B;을(를) 정의합니다. SBSAR 파일은 .alchfilter 파일 옆의 **resources** 폴더에 있어야 합니다.
...
* 사용법: 사용할 용도를 선언합니다. 세 가지 옵션이 있습니다.
  * 한 번에 한 번의 사용으로 링크를 선언합니다(baseColor, normal, Height, ambientOcclusion, roughness, metallic, diffuse, Specular, 광택도, specularLevel, opacity, 방출, scan1, ...).
