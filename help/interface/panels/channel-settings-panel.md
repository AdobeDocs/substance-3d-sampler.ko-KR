...
재질 모델을 변경할 때 새 모델에 대해 레이어 스택을 다시 계산해야 하며 다른 채널을 사용할 수 있게 됩니다. Sampler은 변환에서 데이터 손실을 최소화하려고 하지만 이러한 변경으로 인해 새 재질 모델과 모양에 미세한 차이가 발생할 수 있습니다.

>[!NOTE]
>
> Adobe Standard Material(ASM)에서 OpenPBR으로 변경할 수 있지만 현재 OpenPBR에서 ASM으로 변경할 수는 없습니다.
...
1. [가시성] 토글을 사용하여 2D 보기의 채널을 표시하거나 숨깁니다.
