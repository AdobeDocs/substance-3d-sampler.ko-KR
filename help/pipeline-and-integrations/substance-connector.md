...
이제 4.5 Sampler 릴리스에서 Sampler의 에셋을 커넥터가 구현된 모든 앱으로 직접 보낼 수 있습니다.\
수동 내보내기 및 가져오기 프로세스를 거치지 않고 시간을 절약할 수 있도록 Sampler에서 한 번의 클릭으로 에셋을 타사 애플리케이션으로 보낼 수 있습니다.

오늘 보내기 는 Substance 플러그인을 통해 Blender, Unreal Engine, Unity, 3ds Max 및 Maya에서 사용할 수 있습니다.

## 지원되는 앱 버전

보내기 기능을 사용하려면 Sampler, 서드파티 애플리케이션 및 플러그인의 올바른 버전이 있어야 합니다.

보내기 기능을 사용할 수 있는 최소 버전은 다음과 같습니다.

* <b>Unreal 엔진 플러그인</b>
  * UE5.4 이후의 모든 기능이 완벽하게 지원됩니다.
  * *UE 마켓플레이스에서 릴리스됨*
...
* <b>Unity 플러그인 v3.11+</b>
  ...
  * *Asset Store에서 플러그인을 다운로드해야 합니다*
