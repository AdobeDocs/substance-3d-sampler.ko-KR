...
텍스트 텍스처 기능을 사용하면 텍스트 프롬프트에서 텍스처를 생성하기 위해 보유한 아이디어를 빠르게 시도해 볼 수 있습니다.
...
그런 다음 다른 텍스처와 마찬가지로 결과를 사용할 수 있습니다. 예를 들어, Image-to-Material을 실행하고 그 위에 필터를 더 추가할 수 있습니다.
...
<b>이미지-텍스처</b>은(는) 비율에 관계없이 모든 <b>참조 이미지</b>에서 <b>정방형 및 타일링 텍스처</b>의 네 가지 명제를 만듭니다. 이미 보유한 텍스처의 <b>변형을 생성</b>하거나 보유한 참조 이미지에서 바로 사용할 수 있는 텍스처를 만들 수 있습니다.

이미지를 텍스처로 사용하려면 다음을 수행하십시오.

1. 왼쪽 도구 모음에서 <b>생성형(Beta) </b>패널을 엽니다.
1. 유형 드롭다운 목록에서 &quot;<b>텍스처</b>&quot;를 선택합니다.
1. <b>이미지를 텍스트 필드</b>에 끌어다 놓거나 &quot;이미지 추가&quot; 아이콘을 클릭하여 파일 탐색기를 열고 참조로 사용할 이미지를 선택합니다.
1. <b>생성</b>을 사용하여 참조 이미지에서 영감을 받은 텍스처 생성을 시작합니다. 이 기능을 사용할 때마다 네 가지 변형이 생성됩니다.
