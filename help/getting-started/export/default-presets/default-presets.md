...
Sampler에는 가져오려는 소프트웨어에 따라 비트맵 텍스처를 압축하고 이름을 지정하는 내보내기 사전 설정 목록이 포함되어 있습니다.
...
* [유니티 HDRP Specular](unity-hdrp-specular.md)
* [유니티 스탠다드](unity-standard.md)
* [유니티 Specular](unity-specular.md)
* [언리얼 엔진](unreal-engine-4.md)
* [Redshift](redshift.md)
* [V-레이 다음](v-ray-next.md)
